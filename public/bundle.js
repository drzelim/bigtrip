...
/* harmony export */   "getOffersId": () => (/* binding */ getOffersId),
...
const offers = [
  ...
  {id: 2, text: 'Add luggage', price: 50, type: (0,_random_generator_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(pointType)},
  {id: 3, text: 'Switch to comfort', price: 80, type: (0,_random_generator_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(pointType)},
  {id: 4, text: 'Rent a car', price: 200, type: (0,_random_generator_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(pointType)},
  {id: 5, text: 'Add breakfast', price: 50, type: (0,_random_generator_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(pointType)},
  {id: 6, text: 'Lunch in city', price: 30, type: (0,_random_generator_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(pointType)},
  {id: 7, text: 'Book tickets', price: 40, type: (0,_random_generator_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(pointType)},
  {id: 8, text: 'Order Uber', price: 20, type: (0,_random_generator_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(pointType)},
  {id: 9, text: 'Add luggage', price: 50, type: (0,_random_generator_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(pointType)},
  {id: 10, text: 'Switch to comfort', price: 80, type: (0,_random_generator_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(pointType)},
  {id: 11, text: 'Rent a car', price: 200, type: (0,_random_generator_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(pointType)},
  {id: 12, text: 'Add breakfast', price: 50, type: (0,_random_generator_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(pointType)},
  {id: 13, text: 'Lunch in city', price: 30, type: (0,_random_generator_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(pointType)},
  {id: 14, text: 'Book tickets', price: 40, type: (0,_random_generator_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(pointType)},
];
...
const getDestination = (city, desc) => desc.filter((item) => item.name === city);

const getOffersId = (type) => offers.filter((offer) => type === offer.type).map((item) => item.id);

const getRandomPoint = () => {
  const randomIndex = (0,_random_generator_js__WEBPACK_IMPORTED_MODULE_0__.getRandomInt)(0, startTime.length - 1);
  const randomType = (0,_random_generator_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(pointType);
  const randomCity = (0,_random_generator_js__WEBPACK_IMPORTED_MODULE_0__.getRandomArrayElement)(cities);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ NewPointPresenter)
/* harmony export */ });
/* harmony import */ var _utils_render_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../utils/render.js */ "./src/utils/render.js");
/* harmony import */ var _view_new_point_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/new-point.js */ "./src/view/new-point.js");
...
class NewPointPresenter {
  ...
  _setNewEventBtnClickHandler() {
    ...
    this._newPointComponent = new _view_new_point_js__WEBPACK_IMPORTED_MODULE_1__["default"](newPoint, this._offers);
    (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.render)(this._container, this._newPointComponent, _utils_render_js__WEBPACK_IMPORTED_MODULE_0__.RenderPosition.AFTERBEGIN);
  ...
  destroy() {
    if (this._newPointComponent) {
      (0,_utils_render_js__WEBPACK_IMPORTED_MODULE_0__.remove)(this._newPointComponent);
      this._newPointComponent = null;
...
class Point {
  ...
  init(point, data) {
    ...
    this._pointComponent = new _view_points_js__WEBPACK_IMPORTED_MODULE_2__["default"](this._point, this._data);
    this._editPointComponent = new _view_edit_point_js__WEBPACK_IMPORTED_MODULE_1__["default"](this._point, this._data);
...
/* harmony import */ var _new_point_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./new-point.js */ "./src/presenter/new-point.js");
...
class Trip {
  ...
  _renderPoint(container, point, data) {
    const pointPresenter = new _point_js__WEBPACK_IMPORTED_MODULE_6__["default"] (container, this._newPointPresenter, this._onFavoriteChange, this._onCloseAllEdit);
  ...
  _initNewPoint() {
    ...
    this._newPointPresenter = new _new_point_js__WEBPACK_IMPORTED_MODULE_9__["default"](this._pointsContainer, this._offers, newEventBtn);
    newEventBtn.addEventListener('click', () => {
      this._newPointPresenter.init();
      this._onSortPoints(_utils_const_js__WEBPACK_IMPORTED_MODULE_8__.SORT_TYPE.DAY);
      this. _onCloseAllEdit();
    });
  }
...
/* harmony export */   "getOfferCheckbox": () => (/* binding */ getOfferCheckbox),
/* harmony export */   "getPhoto": () => (/* binding */ getPhoto),
/* harmony export */   "getPhotoFromDestinaitons": () => (/* binding */ getPhotoFromDestinaitons),
/* harmony export */   "getIsPointType": () => (/* binding */ getIsPointType),
/* harmony export */   "getIsPointCity": () => (/* binding */ getIsPointCity)
/* harmony export */ });
...
const getPhotoFromDestinaitons = (data, city) => {
...
/* harmony import */ var _mock_random_point_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../mock/random-point.js */ "./src/mock/random-point.js");
/* harmony import */ var _utils_point_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../utils/point.js */ "./src/utils/point.js");
...
/* harmony import */ var _node_modules_flatpickr_dist_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../node_modules/flatpickr/dist/flatpickr.min.css */ "./node_modules/flatpickr/dist/flatpickr.min.css");
...
const createEditPoint = (point, offers) => {
  ...
  const city = (0,_utils_point_js__WEBPACK_IMPORTED_MODULE_5__.getIsPointCity)(point).join('');
  const type = (0,_utils_point_js__WEBPACK_IMPORTED_MODULE_5__.getIsPointType)(point).join('');
  const description = (0,_mock_random_point_js__WEBPACK_IMPORTED_MODULE_4__.getDestination)(city, _mock_random_point_js__WEBPACK_IMPORTED_MODULE_4__.descriptions);
  return (
      ...
      <header class="event__header">
        ...
        <div class="event__field-group  event__field-group--destination">
          ...
          <datalist id="destination-list-1">
           ${(0,_utils_point_js__WEBPACK_IMPORTED_MODULE_5__.getAllCities)(_main_js__WEBPACK_IMPORTED_MODULE_3__.points).join('\n')}
          </datalist>
        </div>

        <div class="event__field-group  event__field-group--time">
          <label class="visually-hidden" for="event-start-time-1">From</label>
          <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${dayjs__WEBPACK_IMPORTED_MODULE_2___default()(point.startTime)}">
          &mdash;
          <label class="visually-hidden" for="event-end-time-1">To</label>
          <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${dayjs__WEBPACK_IMPORTED_MODULE_2___default()(point.endTime)}">
        </div>
        ...
        <div class="event__field-group  event__field-group--price">
          ...
          <input class="event__input  event__input--price" id="event-price-1" type="text" name="event-price" value="${(0,_utils_point_js__WEBPACK_IMPORTED_MODULE_5__.price)(fullOffers)}">
        </div>
      ...
      <section class="event__details">
        <section class="event__section  event__section--offers ${fullOffers.length === 0 ? 'visually-hidden' : ''}">
          ...
          <div class="event__available-offers ">
            ${(0,_utils_point_js__WEBPACK_IMPORTED_MODULE_5__.getOfferCheckbox)(fullOffers).join('\n')}
          </div>
        </section>
        ...
        <section class="event__section  event__section--destination">
          ...
          <div class="event__photos-container">
            ...
            ${(0,_utils_point_js__WEBPACK_IMPORTED_MODULE_5__.getPhotoFromDestinaitons)(_mock_random_point_js__WEBPACK_IMPORTED_MODULE_4__.descriptions, city).join('\n')}
            </div>
          </div>
        </section>
      </section>
...
class EditPoint extends _smart_js__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _setDatePicker() {
    ...
    this._datePickerStart = (0,flatpickr__WEBPACK_IMPORTED_MODULE_6__["default"])(
    ...
    this._datePickerEnd = (0,flatpickr__WEBPACK_IMPORTED_MODULE_6__["default"])(
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ NewPoint)
/* harmony export */ });
/* harmony import */ var _mock_random_point__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../mock/random-point */ "./src/mock/random-point.js");
...
/* harmony import */ var _edit_point__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./edit-point */ "./src/view/edit-point.js");
...
/* harmony import */ var _node_modules_flatpickr_dist_flatpickr_min_css__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../../node_modules/flatpickr/dist/flatpickr.min.css */ "./node_modules/flatpickr/dist/flatpickr.min.css");
...
const createNewPoint = (point, offers) => {
  const fullOffers = (0,_utils_common_js__WEBPACK_IMPORTED_MODULE_3__.getOffers)(point, offers);
  const city = (0,_utils_point_js__WEBPACK_IMPORTED_MODULE_2__.getIsPointCity)(point).join('');
  const type = (0,_utils_point_js__WEBPACK_IMPORTED_MODULE_2__.getIsPointType)(point).join('');
  const description = (0,_mock_random_point__WEBPACK_IMPORTED_MODULE_0__.getDestination)(city, _mock_random_point__WEBPACK_IMPORTED_MODULE_0__.descriptions);
  return (
    `<form class="event event--edit" action="#" method="post">
      <header class="event__header">
        <div class="event__type-wrapper">
        ...
        <div class="event__field-group  event__field-group--destination">
          ...
          <input class="event__input  event__input--destination" id="event-destination-1" type="text" name="event-destination" value="${city}" list="destination-list-1">
          <datalist id="destination-list-1">
           ${(0,_utils_point_js__WEBPACK_IMPORTED_MODULE_2__.getAllCities)(_main__WEBPACK_IMPORTED_MODULE_4__.points).join('\n')}
          </datalist>
        </div>

        <div class="event__field-group  event__field-group--time">
          <label class="visually-hidden" for="event-start-time-1">From</label>
          <input class="event__input  event__input--time" id="event-start-time-1" type="text" name="event-start-time" value="${dayjs__WEBPACK_IMPORTED_MODULE_5___default()(point.startTime)}">
          &mdash;
          <label class="visually-hidden" for="event-end-time-1">To</label>
          <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${dayjs__WEBPACK_IMPORTED_MODULE_5___default()(point.endTime)}">
        </div>
        <span id="event__time-error" class="visually-hidden" style="color: red; font-size: 14px">Дата начала события не может быть раньше даты окончания события</span>
        ...
        <div class="event__field-group  event__field-group--price">
          ...
          <input class="event__input  event__input--price" id="event-price-1" type="text" name="event-price" value="${(0,_utils_point_js__WEBPACK_IMPORTED_MODULE_2__.price)(fullOffers)}">
        </div>
      ...
      <section class="event__details">
        <section class="event__section  event__section--offers ${fullOffers.length === 0 ? 'visually-hidden' : ''}">
          ...
          <div class="event__available-offers ">
            ${(0,_utils_point_js__WEBPACK_IMPORTED_MODULE_2__.getOfferCheckbox)(fullOffers).join('\n')}
          </div>
        </section>
        ...
        <section class="event__section  event__section--destination">
          ...
          <div class="event__photos-container">
            <div class="event__photos-tape">
              ${(0,_utils_point_js__WEBPACK_IMPORTED_MODULE_2__.getPhotoFromDestinaitons)(_mock_random_point__WEBPACK_IMPORTED_MODULE_0__.descriptions, city).join('\n')}
            </div>
          </div>
        </section>
      </section>
...
class NewPoint extends _smart__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(point, offers) {
    super();

    this._point = point;
    this._data = _edit_point__WEBPACK_IMPORTED_MODULE_6__["default"].parsePointToData(point);
    this._offers = offers;
  ...
  reset(data) {
    this.updateData(_edit_point__WEBPACK_IMPORTED_MODULE_6__["default"].parsePointToData(data));
  }
  ...
  _setDatePicker() {
    ...
    this._datePickerStart = (0,flatpickr__WEBPACK_IMPORTED_MODULE_7__["default"])(
      this.getElement().querySelector('#event-start-time-1'),
      {
        dateFormat: 'd-m-y H:i',
        enableTime: true,
    ...
    this._datePickerEnd = (0,flatpickr__WEBPACK_IMPORTED_MODULE_7__["default"])(
      this.getElement().querySelector('#event-end-time-1'),
      {
        dateFormat: 'd-m-y H:i',
        enableTime: true,
...
class Smart extends _abstarct__WEBPACK_IMPORTED_MODULE_0__["default"] {
